...
package Log_Filter is
   ...
   procedure filter_check (p_filters : store_Filter; p_number_of_filters : Natural; p_word : String; p_word_length : Natural; p_filter_state : in out store_Filter_State);   
